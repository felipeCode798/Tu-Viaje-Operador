...
interface ConfirmadosListProps {
  typeItem?: "tour" | "bus";
  status?: string;
  colorFont?: "pendienteColor" | "canceladoColor" | "finalizadoColor" | "progresoColor";
  time?: string;
  route?: string;
}

export default class ConfirmadosList extends Component<ConfirmadosListProps> {
  render() {
    const {
      typeItem = "tour",
      status = "pendiente",
    ...
    return (
      <View style={styles.infoData}>
        ...
        <View style={styles.statusPaq}>
          <Text style={[styles[colorFont], styles.infoDataText]}> {status}</Text>
        </View>
      </View>
    );
  }
