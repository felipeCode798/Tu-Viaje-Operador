...
// Importación segura de Icon con manejo de tipos
let Icon: any;

try {
  Icon = require("react-native-vector-icons/FontAwesome").default;
} catch (error) {
  console.warn('react-native-vector-icons/FontAwesome not available');
  // Componente de fallback
  Icon = ({ name, size, color, style }: any) => (
    <Text style={[{ color, fontSize: size }, style]}>{name}</Text>
  );
}
